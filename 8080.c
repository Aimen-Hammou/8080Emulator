...
int DISASSEMBLE(const unsigned char *BinaryBuffer, int PC, int FileSize);
...
int main(int argc, char const *argv[])
{
	...
	const char *BinaryBuffer = ( char * ) malloc ( size );
	...
	while ( ProgramCounter < size /* + 0x200 */)
	{
		...
		ProgramCounter = ProgramCounter + DISASSEMBLE(BinaryBuffer,ProgramCounter, size);

	}
	DISASSEMBLE( BinaryBuffer , ProgramCounter, size );
